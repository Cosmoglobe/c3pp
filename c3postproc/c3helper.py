...
def c3help(op, nsysargs):
    ...
    if str(op) == "stddev":
        ...
        if nsysargs < 7:
            print("Usage: ")
            print("c3pp mean [.h5 filename] [h5 dataset (ex. cmb/sigma_l)] [sample range min] [sample range max] (OPTIONAL: [-smooth FWHM]) [output name (name.fits/name.dat)]")
            print("example: ")
        ...
        if nsysargs < 6:
            ...
            print("This tool outputs a .dat file of binned powerspectra averaged over a range of output samples with filename Dl_[signal]_binned.dat ")
            quit()
